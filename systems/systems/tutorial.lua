--========================================================--
-- IRON SOUL V59.3 - TUTORIAL / STARTER
--
-- Proven starter:
...
if not UnForgeUtil then
    warn(
        "[IronSoul V59.3] Tutorial: UnForgeUtil missing."
    )
...
then
    ...
    if ok and info then
        print(
            "[IronSoul V59.3] Tutorial starter index1="
                .. tostring(
                    info.ID
                    or info.Name
                    or "Sword"
...
then
    print(
        "[IronSoul V59.3] Selecting starter Sword."
    )
...
if skip then
    print(
        "[IronSoul V59.3] Tutorial native flow did not teleport; using one-time Skip Tutorial fallback."
    )
...
warn(
    "[IronSoul V59.3] Tutorial still stuck; direct Lobby fallback."
)
