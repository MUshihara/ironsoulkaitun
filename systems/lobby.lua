--========================================================--
-- IRON SOUL - CONTINUOUS LOBBY BRAIN V59
--
-- RUN IN LOBBY.
--
...
log(
    "SUCCESS: V59 lobby progression + matchmaking complete. "
        .. "Bootstrap will continue in the dungeon."
)
...
print("")
print("======================================================")
print(" IRON SOUL CONTINUOUS LOBBY V59")
print(" Decision: " .. tostring(decision))
print(
    " Target: "
        .. tostring(target.WorldId)
        .. " Diff_"
        .. tostring(target.DiffLevel)
)
print(" Level: " .. tostring(level()))
print(" Power: " .. tostring(power()))
print(" Teleport: " .. tostring(started))
print("======================================================")
