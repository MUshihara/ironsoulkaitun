-- IRON SOUL - V61.14.2 COMBAT ENTRY
--
...
-- current-1 gate, bounded to 650 studs. Already-open gates now cross the full
...
local function getPatcher()
    ...
    local patcher = fn()
    assert(type(patcher) == "function", "V61.14.2 combat patch loader unavailable")
    return patcher
end
